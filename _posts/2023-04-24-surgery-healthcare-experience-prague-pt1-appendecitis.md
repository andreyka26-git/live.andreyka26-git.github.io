...
Now I'm using more advanced symptom tracker [SyncSymptom](https://syncsymptom.com), that can track all the pains, symptoms, medications, food, and sport activities. It is much better health diary than just plain notes.

As you can see I have used just Google Docs, but now I created my own application called [SyncSymptom](https://syncsymptom.com), where you can track your pains, symptoms, medications and other health related entries with analytics, search and export.
